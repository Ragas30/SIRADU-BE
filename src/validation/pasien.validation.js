...
const pasienIdSchema = trimStr.cuid({
  message: "Pasien ID harus berupa CUID yang valid",
});
...
export class PasienValidation {
  ...
  static UPDATE_BY_ID = z.object({
    ...
    .refine((data) => Object.values(data).every((v) => v !== undefined), { message: "Semua field harus diubah" });
}
